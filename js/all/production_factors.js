...
$(document).on('click','.editButton',function () {
  ...
  let roleType=$(this).parent().prev().prev().text();
  // let roleType_chinese;
  // console.log(roleType);
  // if(roleType=="原材料"){
  //   roleType_chinese="原材料";
  // }else if(roleType=="半成品"){
  //   roleType_chinese="半成品";
  // }else{
  //   roleType_chinese="成品";
  // }
  // console.log(roleType);
